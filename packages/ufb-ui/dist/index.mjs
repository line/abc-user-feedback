...
import React__default, { forwardRef, useMemo, useState, useRef, useImperativeHandle, useCallback, useEffect, useId } from 'react';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import { toast as toast$1, Toaster as Toaster$1 } from 'react-hot-toast';
import { useFloating, offset, flip, shift, arrow, autoUpdate, useHover, useFocus, useDismiss, useRole, useInteractions, FloatingArrow, useClick, FloatingPortal, FloatingOverlay, FloatingFocusManager, useMergeRefs, useId as useId$1 } from '@floating-ui/react';
...
const Icon = _a => {
  ...
  return React.createElement(svg[name], Object.assign({
    width: size,
    height: size,
...
const Input = forwardRef((props, ref) => {
  ...
  return jsxs("div", Object.assign({
    ...
    children: [label && jsxs("label", Object.assign({
      htmlFor: label,
      className: "input-label"
    }, {
      children: [label, ' ', props.required && jsx("span", Object.assign({
      ...
      children: [jsx("input", Object.assign({
        ...
        ref: ref
      }, rest)), leftChildren && jsx("div", Object.assign({
        className: "absolute absolute-y-center left-[14px] flex gap-2 items-center"
      }, {
        children: leftChildren
      })), rightChildren && jsx("div", Object.assign({
...
const TextInput = forwardRef((props, ref) => {
  ...
  return jsx(Input, Object.assign({
    leftChildren: leftIconName && jsx(Icon, {
      size: props.size === 'sm' ? 16 : 20,
      name: leftIconName,
      className: "text-tertiary"
    }),
    rightChildren: jsxs(Fragment, {
      children: [!rest.disabled && (iconType === 'clear' ? jsx("button", Object.assign({
        type: "button",
      ...
      })) : iconType === 'success' ? jsx(Icon, {
        size: props.size === 'sm' ? 16 : 20,
        name: "CircleCheck",
        className: "text-blue-primary"
      }) : iconType === 'fail' ? jsx(Icon, {
        size: props.size === 'sm' ? 16 : 20,
        name: "WarningCircleFill",
        className: "text-red-primary"
      }) : jsx(Fragment, {})), rightChildren]
    }),
...
const ToastBox = ({
  ...
  return jsxs("div", Object.assign({
    ...
    children: [jsx(Icon, {
      ...
      children: [title && jsx("p", Object.assign({
...
const toast = {
  positive: input => toast$1.custom(t => jsx(ToastBox, Object.assign({
    type: "positive"
  }, input, {
    t: t
  }))),
  negative: input => toast$1.custom(t => jsx(ToastBox, Object.assign({
    type: "negative"
  }, input, {
    t: t
  }))),
  promise: (fn, input, theme = 'light', option) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const id = toast$1.custom(t => jsx(ToastPromiseBox, Object.assign({}, option, {
      t: t,
      status: "loading",
      title: title.loading,
    ...
    fn.then(() => {
      toast$1.custom(t => jsx(ToastPromiseBox, Object.assign({}, option, {
        t: t,
        status: "success",
        title: title.success,
...
const Tooltip = ({
  ...
  return jsxs(Fragment, {
    children: [React__default.cloneElement(children, Object.assign({
      ref: refs.setReference
    }, getReferenceProps())), isOpen && jsxs("div", Object.assign({
      ref: refs.setFloating,
      style: floatingStyles,
      className: "bg-fill-primary px-4 py-2.5 font-12-regular text-inverse rounded"
    }, getFloatingProps(), {
      children: [title, jsx(FloatingArrow, {
        ref: arrowRef,
        context: context
      })]
    }))]
...
const Dialog = props => {
  ...
  return jsx(Fragment, {
    children: open && jsx(FloatingPortal, {
      children: jsx(FloatingOverlay, Object.assign({
        lockScroll: true,
        className: "bg-dim",
        style: {
          display: 'grid',
        ...
        children: jsx(FloatingFocusManager, Object.assign({
          context: context
        }, {
          children: jsxs("div", Object.assign({
            ...
            children: [jsx("h1", Object.assign({
              ...
              children: title
            })), icon && jsx("div", Object.assign({
              className: "text-center mb-6"
            }, {
              children: jsx(Icon, Object.assign({}, icon))
            })), description && jsx("p", Object.assign({
              id: descriptionId,
              ...
              children: children
            })), bottomButtons && jsx("div", Object.assign({
              className: "flex justify-end gap-2"
            }, {
              children: bottomButtons.map(button => jsx("button", Object.assign({}, button)))
            }))]
          }))
        }))
      }))
...
function usePopover({
  ...
  return React.useMemo(() => Object.assign(Object.assign(Object.assign({
    open,
    setOpen
  }, interactions), data), {
    modal,
...
function Popover(_a) {
  ...
  return jsx(PopoverContext.Provider, Object.assign({
    value: popover
  }, {
    children: children
  }));
...
const PopoverTrigger = React.forwardRef(function PopoverTrigger(_a, propRef) {
  ...
  if (asChild && React.isValidElement(children)) {
    return React.cloneElement(children, context.getReferenceProps(Object.assign(Object.assign(Object.assign({
      ref
...
const PopoverContent = React.forwardRef(function PopoverContent(_a, propRef) {
  var {
      style,
      isPortal = false,
  ...
  const child = jsx(FloatingFocusManager, Object.assign({
    context: floatingContext,
    modal: context.modal
  }, {
  ...
  const modalChild = context.modal ? jsx(FloatingOverlay, Object.assign({
  ...
  return isPortal ? jsx(FloatingPortal, {
    children: modalChild
  }) : modalChild;
});
const PopoverHeading = React.forwardRef(function PopoverHeading(props, ref) {
  const {
    setLabelId,
    setOpen
  } = usePopoverContext();
...
export { Badge, Dialog, Icon, IconNames, Input, Popover, PopoverContent, PopoverHeading, PopoverTrigger, TextInput, Toaster, Tooltip, toast, usePopover, usePopoverContext };
