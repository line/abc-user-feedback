...
@EventSubscriber()
export class IssueTrackerHistorySubscriber extends AbstractHistorySubscriber<IssueTrackerEntity> {
  constructor(
    @InjectDataSource() dataSource: DataSource,
    readonly cls: ClsService,
    readonly historyService: HistoryService,
  ) {
    super(dataSource, cls, historyService, EntityNameEnum.IssueTracker);
  }
  listenTo() {
