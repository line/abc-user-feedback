...
| 환경 변수                            | 설명                                                     | 기본값                                        | 예시   |
| ------------------------------------ | -------------------------------------------------------- | --------------------------------------------- | ------ |
| `AUTO_FEEDBACK_DELETION_ENABLED`     | 애플리케이션 시작 시 자동 오래된 피드백 삭제 크론 활성화 | `false`                                       | `true` |
| `AUTO_FEEDBACK_DELETION_PERIOD_DAYS` | 자동 오래된 피드백 삭제 기간(일)                         | _AUTO_FEEDBACK_DELETION_ENABLED=true 시 필수_ | `365`  |
