...
| `BASE_URL`                   | Base URL of the application                      | _Required_ | `http://api:4000`                                           |
...
| `SMTP_BASE_URL`          | Base URL for connecting from email to application | _Optional_ | `http://localhost:3000` |
