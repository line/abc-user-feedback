...
새로운 사용자이신가요? [시작하기](./02-getting-started) 섹션에서 다음 내용을 확인하세요:

- [시스템 요구사항](./02-getting-started/01-system-requirements.md) - 설치 전 필요한 환경
- [설치 가이드](./02-getting-started/02-installation) - Docker, CLI 도구 또는 수동 설치 방법
...
- [FAQ](./07-community-support/01-faq.md) - 자주 묻는 질문
- [알려진 이슈](./07-community-support/02-known-issues.md) - 현재 알려진 문제점
